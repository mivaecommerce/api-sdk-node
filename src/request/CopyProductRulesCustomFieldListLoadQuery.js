...
/** 
 * Handles API Request CopyProductRulesCustomFieldList_Load_Query. Scope: Store. 
...
class CopyProductRulesCustomFieldListLoadQuery extends ListQueryRequest {
  ...
  constructor(client, copyProductRule = null) {
    super(client);
    this.function = 'CopyProductRulesCustomFieldList_Load_Query';
  ...
  createResponse(httpResponse, data) {
    return new responses.CopyProductRulesCustomFieldListLoadQuery(this, httpResponse, data);
  }
}

module.exports.CopyProductRulesCustomFieldListLoadQuery = CopyProductRulesCustomFieldListLoadQuery;